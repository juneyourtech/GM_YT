...
//TITLE
GM_addStyle("DIV#watch7-headline, HTML.not-watch8 #watch-headline {padding-left:0px; padding-right:165px; position:relative;}")
...
//GM_addStyle("DIV.autoplay-bar .autoplay-info-icon {margin-top:0px; background-position:-263px -189px;}") //that's nitpicking already...
